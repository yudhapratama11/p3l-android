...
import com.b_laundry.p3l.p3l.adapter.SparepartStokAdapter;
...
public class AdminSparepartFragmentStok extends Fragment {
    View v;
    private RecyclerView recyclerView;
    private SparepartStokAdapter sparepartAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        sparepartAdapter = new SparepartStokAdapter(this,sparepartList1);
    ...
    public void getSparepart(){
        ...
        Call<SparepartResponse> call = service.getSparepartLowStock();
    ...
    public void generateDataList(SparepartResponse sparepartList) {
        ...
        sparepartAdapter = new SparepartStokAdapter(this,sparepartList);
