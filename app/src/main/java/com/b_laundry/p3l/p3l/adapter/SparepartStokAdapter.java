...
public class SparepartStokAdapter extends RecyclerView.Adapter<SparepartStokAdapter.ViewHolder> {
    private AdminSparepartFragmentStok context;
    public SparepartResponse sparepartList;
    List<Sparepart> arrayList = new ArrayList<>();

    public SparepartStokAdapter(AdminSparepartFragmentStok context, SparepartResponse sparepartList) {
