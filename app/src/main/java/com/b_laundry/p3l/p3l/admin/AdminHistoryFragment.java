...
import com.b_laundry.p3l.p3l.adapter.HistoryAdapter;
...
public class AdminHistoryFragment extends Fragment {
    ...
    private HistoryAdapter salesAdapter;
    private HistorySparepartResponse salesList;
    ...
    {
        v = inflater.inflate(R.layout.admin_history_fragment, container, false);
        recyclerView = v.findViewById(R.id.card_recycler_view);
        salesAdapter = new HistoryAdapter(this,salesList);
...
//        });
    ...
    public void getSales(){
        ...
        Call<HistorySparepartResponse> call = service.getHistory();
        //Log.d("responsecode", String.valueOf(request.getSparepart()));

        call.enqueue(new Callback<HistorySparepartResponse>() {
            @Override
            public void onResponse(Call<HistorySparepartResponse> call, Response<HistorySparepartResponse> response) {
                generateDataList(response.body());
            }

            @Override
            public void onFailure(Call<HistorySparepartResponse> call, Throwable t) {
                Log.d("Error",t.getMessage());
            }
        });
    }
    private void generateDataList(HistorySparepartResponse salesList) {
